...
- **X投稿用であっても、文字数制限を気にして内容を削ってはならない。** 長文投稿（Long Post）機能を前提とし、記事本文と100%同一のテキスト（フォーマット調整のみ）を提供すること。
- **記事で使用した全画像を `_X/記事名/images/` にコピーして含めること**。画像が100枚以上ある場合でも、すべてコピーすること。
