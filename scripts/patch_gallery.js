...
const targetFile = path.join(__dirname, '..', 'brotherhood-of-steel.html');
const galleryFragmentFile = path.join(__dirname, 'gallery_fragment.txt');

// ギャラリーHTMLを再生成（文字化け防止のためスクリプト内で定義）
const images = [
  ...
  { file: "Dlc03watercrate.png", caption: "アクア・プーラの補給箱", cat: "Fallout 3 / NV" },
  ...
  { file: "FO76LR_Fortifying_ATLAS_Dorsey.jpg", caption: "フォート・アトラスのドーシー", cat: "Fallout 76" },
  ...
  { file: "FO76_BoS_GY_1.png", caption: "フォート・アトラス 墓地", cat: "Fallout 76" },
...
let galleryHtml = `            <div class="gallery-section">
                <h2>ギャラリー</h2>
...
// 正規表現でギャラリーセクションを置換
// <div class="gallery-section"> ... </div> (感想の手前まで)
const startMarker = '<div class="gallery-section">';
...
if (startIndex !== -1 && endIndex !== -1) {
    const newContent = content.substring(0, startIndex) + galleryHtml + '\n\n            ' + content.substring(endIndex);
    fs.writeFileSync(targetFile, newContent, 'utf8');
    console.log('Gallery successfully updated with 114 images.');
} else {
