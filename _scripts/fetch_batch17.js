...
const main = async () => {
    const articles = {
        "Robert (Whitespring)": "Robert (Whitespring)",
        "Sidney": "Sidney",
        "Dillo": "Dillo",
        "Jooky hair salon": "Jooky hair salon"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch17.json', JSON.stringify(results, null, 2));
    console.log('Batch 17 wikitext fetched and saved.');
};
