...
const main = async () => {
    const articles = {
        "Bubbles": "Bubbles",
        "Tannin": "Tannin",
        "Toxic Dried Lakebed": "Toxic dried lakebed",
        "Whitespring driving range": "Whitespring driving range"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch23.json', JSON.stringify(results, null, 2));
    console.log('Batch 23 wikitext fetched and saved.');
};
