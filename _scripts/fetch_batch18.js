...
const main = async () => {
    const articles = {
        "Needles": "Needles",
        "Old storehouse": "Old storehouse",
        "Pioneer Scout lookout": "Pioneer Scout lookout",
        "Southhampton Estate": "Southhampton Estate"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch18.json', JSON.stringify(results, null, 2));
    console.log('Batch 18 wikitext fetched and saved.');
};
