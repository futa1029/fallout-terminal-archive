...
const main = async () => {
    const articles = {
        "Cynthia": "Cynthia",
        "Grafton police department": "Grafton Police Department",
        "Monongah overlook": "Monongah overlook",
        "Toxic pond wreckage": "Toxic pond wreckage"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch27.json', JSON.stringify(results, null, 2));
    console.log('Batch 27 wikitext fetched and saved.');
};
