...
const main = async () => {
    const articles = {
        "Brotherhood vendor": "Brotherhood vendor",
        "Slocum's Joe (Watoga)": "Slocum's Joe (Watoga)",
        "Sunny (Steel Dawn)": "Sunny (Steel Dawn)",
        "Vendor bot Responder": "Vendor bot Responder"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch24.json', JSON.stringify(results, null, 2));
    console.log('Batch 24 wikitext fetched and saved.');
};
