...
targets.forEach(slug => {
    ...
    // Calvert intentionally lacks images, so we skip imgExists check for calvert
    let imgExists = (slug === 'calvert') ? true : (fs.existsSync(imgDir) && fs.readdirSync(imgDir).length > 0);
