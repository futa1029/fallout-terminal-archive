...
const main = async () => {
    const articles = {
        "Jacky (Wastelanders)": "Jacky (Wastelanders)",
        "Kanawha National Park": "Kanawha National Park",
        "Watoga Bandstand": "Watoga Bandstand",
        "Pleasant Hills Cemetery": "Pleasant Hills Cemetery"
    };
    ...
    console.log('Batch 21 wikitext fetched and saved.');
};
