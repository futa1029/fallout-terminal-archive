...
let content = fs.readFileSync('f:/Fallout/cynthia.html', 'utf8');

const newContent = `
            <h2>概要</h2>
<p><b>シンシア（Cynthia）</b>は、アパラチアの<a href="the-whitespring-resort.html" class="auto-link">ホワイトスプリング・リゾート</a>（モール内）の施設にいる<a href="miss-nanny.html" class="auto-link">ミス・ナニー</a>型の理容師（NPC）です。</p>

            <h2>背景</h2>
<p>シンシアは、ホワイトスプリング・リゾート内（現在のホワイトスプリング・モール）のショップエリアにあるサロン「エレガンス（Elegance）」の店舗に4体セットで配置されている、自動化された美容師ロボットの1体です。（同じ店舗内にいる他の個体は<a href="carolyn.html" class="auto-link">キャロリン</a>、<a href="claudia.html" class="auto-link">クラウディア</a>、<a href="coretta.html" class="auto-link">コレッタ</a>です。）<br>このサロンは「事前予約なしの飛び込みの客は受け入れていない」という設定になっているため、プレイヤーは彼女たちから直接髪を切ってもらうサービスを受けることはできません。</p>

<p>・シンシア：「ご予約はされていますでしょうか？あいにく今日の予約はいっぱいなのです。」</p>

            <div class="quote-box">
                <b>感想</b><br><br>
                先述の <a href="carolyn.html" class="auto-link">キャロリン</a> と同様に、ホワイトスプリング・モールの理容室ショップ（Elegance）に配置されているミス・ナニー達の1体です。<br>4体とも同じ内容の「あいにく予約でいっぱいです」という断りのセリフを発するため、特に個別の細かい設定などは用意されていないプレイヤーにとって少し不憫な存在となっています。
            </div>
`;

// Replace infobox
let infoboxRegex = /<aside class="infobox">.*?<\/aside>/s;
content = content.replace(infoboxRegex, `<aside class="infobox"><h3 style="margin-top:0;text-align:center;">Cynthia</h3><img src="images/note_extracted/cynthia/img_main.png" alt="Cynthia"><div class="infobox-row"><span class="infobox-label">種類</span><span><a href="miss-nanny.html" class="auto-link">ミス・ナニー</a></span></div><div class="infobox-row"><span class="infobox-label">役職</span><span>理容師（Barber）</span></div><div class="infobox-row"><span class="infobox-label">所属</span><span><a href="the-whitespring-resort.html" class="auto-link">ホワイトスプリング・リゾート</a></span></div><div class="infobox-row"><span class="infobox-label">登場作品</span><span>Fallout 76</span></div></aside>`);

// Replace title
content = content.replace(/<h1>.*?<\/h1>/, "<h1>Cynthia<br><span style=\"font-size:0.6em;color:#888;font-family:'Noto Sans JP',sans-serif;font-weight:normal;\">シンシア</span></h1>");
...
const headerHtml = headerMatch ? headerMatch[0] : `<main class="content">\n            <div class="action-header"><a href="lore.html" class="back-link">&lt; BACK TO TERMINAL</a><button class="like-button" data-article-id="note_cynthia" onclick="toggleLike(this)"><span class="heart">♡</span> <span class="like-count">0</span></button></div>\n            <h1>Cynthia<br><span style="font-size:0.6em;color:#888;font-family:'Noto Sans JP',sans-serif;font-weight:normal;">シンシア</span></h1>`;

const footerContent = `
            <div style="margin-top:30px;border-top:1px dashed var(--accent-color);padding-top:20px;font-size:0.85em;color:#888;">
                <p name="copyright-default">This article was created by translating and editing <a href="https://fallout.fandom.com/wiki/Cynthia" target="_blank" rel="noopener">Cynthia</a> from <a href="https://fallout.fandom.com/" target="_blank" rel="noopener">Nukapedia</a>.<br>Licensed under <a href="https://creativecommons.org/licenses/by-sa/3.0/" target="_blank" rel="noopener">CC BY-SA 3.0</a>.</p>
...
finalHtml = finalHtml.replace(infoboxRegex, `<aside class="infobox"><h3 style="margin-top:0;text-align:center;">Cynthia</h3><img src="images/note_extracted/cynthia/img_main.png" alt="Cynthia"><div class="infobox-row"><span class="infobox-label">種類</span><span><a href="miss-nanny.html" class="auto-link">ミス・ナニー</a></span></div><div class="infobox-row"><span class="infobox-label">役職</span><span>理容師（Barber）</span></div><div class="infobox-row"><span class="infobox-label">所属</span><span><a href="the-whitespring-resort.html" class="auto-link">ホワイトスプリング・リゾート</a></span></div><div class="infobox-row"><span class="infobox-label">登場作品</span><span>Fallout 76</span></div></aside>`);

finalHtml = finalHtml.replace(/<h1>.*?<\/h1>/, "<h1>Cynthia<br><span style=\"font-size:0.6em;color:#888;font-family:'Noto Sans JP',sans-serif;font-weight:normal;\">シンシア</span></h1>");

fs.writeFileSync('f:/Fallout/cynthia.html', finalHtml);
...
fs.mkdirSync('f:/Fallout/_X/cynthia', { recursive: true });
fs.writeFileSync('f:/Fallout/_X/cynthia/post.md', postContent);
