...
const main = async () => {
    const articles = {
        "Middle Mountain Lake": "Middle Mountain Lake",
        "Red Rocket filling station": "Red Rocket filling station",
        "Summersville Dam": "Summersville Dam",
        "Wicker": "Wicker"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch25.json', JSON.stringify(results, null, 2));
    console.log('Batch 25 wikitext fetched and saved.');
};
