...
const main = async () => {
    const articles = {
        "Widow's Perch": "Widow's Perch",
        "Wilkins (Steel Reign)": "Wilkins (Steel Reign)",
        "Harvey Tinley": "Harvey Tinley",
        "Jack Woodhouse": "Jack Woodhouse"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch14.json', JSON.stringify(results, null, 2));
    console.log('Batch 14 wikitext fetched and saved.');
};
