...
const main = async () => {
    const articles = {
        "Deathklaus": "Deathklaus",
        "Samuel Hackerman": "Samuel Hackerman",
        "Summersville Lake": "Summersville Lake",
        "Tweed": "Tweed"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch20.json', JSON.stringify(results, null, 2));
    console.log('Batch 20 wikitext fetched and saved.');
};
