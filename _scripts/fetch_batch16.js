...
const main = async () => {
    const articles = {
        "Wixon homestead": "Wixon homestead",
        "Alexis": "Alexis",
        "Eightball": "Eightball",
        "Pompy": "Pompy"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch16.json', JSON.stringify(results, null, 2));
    console.log('Batch 16 wikitext fetched and saved.');
};
