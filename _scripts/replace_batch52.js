...
const processFile = (filename, pId, enName, jpName) => {
    ...
    // Special fix for toxic-valley
    if (!copyrightFixed && filename === 'toxic-valley.html') {
...
processFile('toxic-valley.html', 'note_toxic_valley', 'Toxic Valley', 'トキシックバレー');
processFile('ae-ri.html', 'note_ae_ri', 'Ae-Ri', 'エイ・リ');
processFile('cedric.html', 'note_cedric', 'Cedric', 'セドリック');
