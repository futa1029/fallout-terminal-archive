...
const main = async () => {
    const articles = {
        "North Kanawha lookout": "North Kanawha lookout",
        "Settler's Ridge": "Settler's Ridge",
        "Ursala": "Ursala",
        "Welch station": "Welch station"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch15.json', JSON.stringify(results, null, 2));
    console.log('Batch 15 wikitext fetched and saved.');
};
