...
function generateLocation(title, wikitext) {
    ...
    let imgHTML = imageInfo ? '<img src="images/note_extracted/' + slug + '/' + imageInfo.replace(/ /g,'_') + '" alt="' + title + '" style="width:100%; border:1px solid var(--accent-color); margin-bottom:15px;">' : '';
    let mapHTML = mapImage ? '<img src="images/note_extracted/' + slug + '/' + mapImage.replace(/ /g,'_') + '" alt="Map" style="width:100%; margin-top:5px;">' : '';
    ...
    <div class="container">
        <main class="content">
            ...
            <div class="quote-box">
                ...
                自動生成によるロケーションインポート。<br>※本テキストは未翻訳のプレースホルダーです。
            </div>
        </main>
    </div>
</body>
...
console.log('Location HTMLs generated (fixed string escapes).');
