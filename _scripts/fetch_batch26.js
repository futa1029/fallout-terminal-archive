...
const main = async () => {
    const articles = {
        "Willard corporate housing": "Willard corporate housing",
        "Relay tower EM-B1-27": "Relay tower EM-B1-27",
        "Sludge trailer": "Sludge trailer",
        "Carolyn": "Carolyn"
    };
    ...
    fs.writeFileSync('f:/Fallout/_wikitext_batch26.json', JSON.stringify(results, null, 2));
    console.log('Batch 26 wikitext fetched and saved.');
};
