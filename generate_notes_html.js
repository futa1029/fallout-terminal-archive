...
function guessCategoryAndAppearance(title, bodyText) {
    ...
    else if (/(おばあちゃん|ダッチェス|モート|ソール|ポリー|キンバル|タンディ|モルデイヴァー|デル・ローソン|モルデカイ|居住者|フランク|ジョン・ハンコック|マジソン・リー|チェイス|サパースタイン|監督官|ロニー|エドウィン|ベケット|ゲイリー|ジェームス|パイパー・ライト|アッシュ・ローズ|アデレード|ドッティ|ジュンコ|ジェフ・ナカムラ|エイミー・ケリー|チャールズ|リー|ザ・クロウ|ゾルボ)/i.test(t)) cat = "人物";
