...
const PERK_DATA = {
    "Strength": [
        ...
        { name: "Basher", level: 4, maxRank: 2, cost: [1, 2], desc: ["銃のバッシュダメージが+25%、部位ダメージが+35%増加する。", "銃のバッシュダメージが+50%、部位ダメージが+75%増加する。"] },
        { name: "Bear Arms", level: 35, maxRank: 3, cost: [1, 2, 3], desc: ["重火器の重量が30%軽くなり、Bullet Stormのスタックごとにバッシュダメージが5%増加する。", "重火器の重量が60%軽くなり、Bullet Stormのスタックごとにバッシュダメージが5%増加する。", "重火器の重量が90%軽くなり、Bullet Stormのスタックごとにバッシュダメージが5%増加する。"] },
        ...
        { name: "Heavy Hitter", level: 35, maxRank: 3, cost: [1, 2, 3], desc: ["打撃系近接武器のパワーアタックダメージが+25%増加する。", "打撃系近接武器のパワーアタックダメージが+50%増加する。", "打撃系近接武器のパワーアタックダメージが+75%増加する。"] },
        ...
        { name: "Knee-Capper", level: 2, maxRank: 3, cost: [2, 3, 4], desc: ["近接武器の部位ダメージが+50%増加する。", "近接武器の部位ダメージが+100%増加する。", "近接武器の部位ダメージが+150%増加する。"] },
        { name: "Lock and Load", level: 2, maxRank: 3, cost: [1, 2, 3], desc: ["重火器のリロード速度が+10%上昇し、リロード時にBullet Stormのスタックを半分保持する。", "重火器のリロード速度が+20%上昇し、リロード時にBullet Stormのスタックを半分保持する。", "重火器のリロード速度が+30%上昇し、リロード時にBullet Stormのスタックを半分保持する。"] },
        ...
        { name: "Natural Stance", level: 15, maxRank: 3, cost: [1, 2, 3], desc: ["近接武器装備時、よろめきにくさが+25%上昇する。", "近接武器装備時、よろめきにくさが+50%上昇する。", "近接武器装備時、よろめきにくさが+75%上昇する。"] },
        ...
        { name: "Tightly Wound", level: 40, maxRank: 1, cost: [1], desc: ["武器のチャージ速度（スピンアップ時間）が60%上昇する。"] },
    ...
    "Perception": [
        { name: "Awareness", level: 27, maxRank: 1, cost: [1], desc: ["PERに応じてV.A.T.S.での命中率が上昇する。"] },
        ...
        { name: "Exterminator", level: 14, maxRank: 3, cost: [1, 2, 3], desc: ["昆虫系の敵のアーマーを25%無視する。", "昆虫系の敵のアーマーを50%無視する。", "昆虫系の敵のアーマーを75%無視する。"] },
        ...
        { name: "Fortune Finder", level: 22, maxRank: 1, cost: [1], desc: ["キャップの入った箱が近くにあると音が鳴る。"] },
        { name: "Glow Sight", level: 33, maxRank: 3, cost: [1, 2, 3], desc: ["発光した敵へのダメージが+20%増加する。", "発光した敵へのダメージが+40%増加する。", "発光した敵へのダメージが+60%増加する。"] },
        ...
        { name: "Ground Pounder", level: 18, maxRank: 3, cost: [1, 2, 3], desc: ["ライフル・ショットガン・ピストルのリロード速度が+10%、腰だめ精度が+15%向上する。", "ライフル・ショットガン・ピストルのリロード速度が+20%、腰だめ精度が+30%向上する。", "ライフル・ショットガン・ピストルのリロード速度が+30%、腰だめ精度が+45%向上する。"] },
        { name: "Long Shot", level: 37, maxRank: 1, cost: [1], desc: ["スコープ付き武器の射程と精度が+30%向上する。"] },
        { name: "Number Cruncher", level: 30, maxRank: 3, cost: [1, 2, 3], desc: ["自動小銃のアーマー貫通が+10%向上する。", "自動小銃のアーマー貫通が+20%向上する。", "自動小銃のアーマー貫通が+30%向上する。"] },
        { name: "Night Person", level: 24, maxRank: 3, cost: [1, 2, 3], desc: ["夜は（6PM-6AM）INTとPERが+1。", "夜は（6PM-6AM）INTとPERが+2。", "夜は（6PM-6AM）INTとPERが+3。"] },
        { name: "Pannapictagraphist", level: 16, maxRank: 1, cost: [1], desc: ["雑誌が近くにあると音が鳴る。"] },
        { name: "Picklock", level: 5, maxRank: 1, cost: [1], desc: ["ピッキングスキル+1。スイートスポット+10%。"] },
        { name: "Refractor", level: 28, maxRank: 1, cost: [1], desc: ["PERに応じてエネルギー耐性が向上する。"] },
        ...
        { name: "Sniper", level: 28, maxRank: 1, cost: [1], desc: ["スコープ越しの息止め時間が75%延長される。"] },
        { name: "Tank Killer", level: 30, maxRank: 2, cost: [1, 2], desc: ["ノンオートマチックライフルが標的のアーマーの20%を無視し、3%の確率でよろめかせる。", "ノンオートマチックライフルが標的のアーマーの40%を無視し、6%の確率でよろめかせる。"] }
    ],
    "Endurance": [
        ...
        { name: "Bullet Shield", level: 39, maxRank: 3, cost: [1, 2, 3], desc: ["ヘビーガン発射中、5%の確率で攻撃を反射する。", "ヘビーガン発射中、10%の確率で攻撃を反射する。", "ヘビーガン発射中、15%の確率で攻撃を反射する。"] },
        ...
        { name: "Ironclad", level: 30, maxRank: 3, cost: [1, 2, 3], desc: ["アーマーの防御力が15%上昇。マッチングセットで効果倍増。", "アーマーの防御力が20%上昇。マッチングセットで効果倍増。", "アーマーの防御力が25%上昇。マッチングセットで効果倍増。"] },
        { name: "Lead Belly", level: 2, maxRank: 3, cost: [1, 2, 3], race: "human", desc: ["食べ物と飲み物からの放射能を30%軽減。", "食べ物と飲み物からの放射能を60%軽減。", "食べ物と飲み物から放射能を受けない。"] },
        { name: "Lifegiver", level: 26, maxRank: 1, cost: [2], desc: ["ENDに応じて最大HPが増加する。"] },
    ...
    "Charisma": [
        ...
        { name: "Inspirational", level: 2, maxRank: 1, cost: [2], desc: ["チームに参加している時、CHAに応じて獲得XPが増加する。"] },
        ...
        { name: "Suppressor", level: 11, maxRank: 3, cost: [1, 2, 3], desc: ["攻撃した標的のダメージ出力を10%減少させる（2秒間）。", "攻撃した標的のダメージ出力を20%減少させる（2秒間）。", "攻撃した標的のダメージ出力を30%減少させる（2秒間）。"] },
        { name: "Team Medic", level: 20, maxRank: 3, cost: [1, 2, 3], desc: ["スティムパック使用時に近くのチームメイトも回復量の50%分回復する。", "スティムパック使用時に近くのチームメイトも回復量の75%分回復する。", "スティムパック使用時に近くのチームメイトも回復量の100%分回復する。"] },
        { name: "Tenderizer", level: 46, maxRank: 1, cost: [2], desc: ["攻撃するたびに標的が受けるダメージが増加する（最大100%）。"] },
    ...
    "Intelligence": [
        ...
        { name: "Demolition Expert", level: 10, maxRank: 3, cost: [1, 2, 3], desc: ["爆発物のダメージが+20%増加する。", "爆発物のダメージが+35%増加する。", "爆発物のダメージが+50%増加する。"] },
        ...
        { name: "Gunsmith", level: 11, maxRank: 3, cost: [1, 2, 3], desc: ["銃の壊れる速度が20%遅くなり、クラフトが向上する。", "銃の壊れる速度が35%遅くなり、クラフトがさらに向上する。", "銃の壊れる速度が50%遅くなり、最高ランクまでクラフト可能。"] },
        ...
        { name: "Makeshift Warrior", level: 9, maxRank: 3, cost: [1, 2, 3], desc: ["近接武器の壊れる速度が20%遅くなり、クラフトが向上する。", "近接武器の壊れる速度が35%遅くなり、クラフトがさらに向上する。", "近接武器の壊れる速度が50%遅くなり、最高ランクまでクラフト可能。"] },
        { name: "Nerd Rage!", level: 19, maxRank: 1, cost: [2], desc: ["HP20%以下でINTに応じてダメージ、DR、AP回復が上昇する。"] },
        ...
        { name: "Stabilized", level: 36, maxRank: 1, cost: [1], desc: ["ヘビーガンの命中精度が+30%向上。PA装着時は効果が2倍。"] },
    ...
    "Agility": [
        ...
        { name: "Dodge", level: 25, maxRank: 3, cost: [1, 2, 3], desc: ["PA未装着時に被弾を10%の確率で回避。ENDに応じて回避率が増加。", "PA未装着時に被弾を20%の確率で回避。ENDに応じて回避率が増加。", "PA未装着時に被弾を30%の確率で回避。ENDに応じて回避率が増加。"] },
        ...
        { name: "Expert Guerrilla", level: 15, maxRank: 1, cost: [1], desc: ["オンスロートの最大スタック数+3。スタックごとにリロード速度+5%。"] },
        { name: "Expert Gunslinger", level: 20, maxRank: 1, cost: [1], desc: ["オンスロートの最大スタック数+3。スタックごとにリロード速度+5%。"] },
        { name: "Guerrilla", level: 2, maxRank: 1, cost: [1], desc: ["オンスロートの最大スタック数+1。スタックごとにリロード速度+5%。"] },
        { name: "Gun Runner", level: 8, maxRank: 1, cost: [2], desc: ["武器装備中の移動速度が+10%速くなる。"] },
        { name: "Gunslinger", level: 6, maxRank: 1, cost: [1], desc: ["オンスロートの最大スタック数+1。スタックごとに弱点ダメージ+4%。"] },
        ...
        { name: "Master Guerrilla", level: 30, maxRank: 1, cost: [1], desc: ["オンスロートの最大スタック数+5。スタックごとに近くの敵へのダメージ+5%。"] },
        { name: "Master Gunslinger", level: 30, maxRank: 1, cost: [1], desc: ["オンスロートの最大スタック数+5。スタックごとに命中精度が上昇。"] },
        ...
        { name: "Ninja", level: 15, maxRank: 3, cost: [1, 2, 3], desc: ["敵に察知されていない時の近接ダメージが+30%増加。", "敵に察知されていない時の近接ダメージが+60%増加。", "敵に察知されていない時の近接ダメージが+90%増加。"] },
    ...
    "Luck": [
        ...
        { name: "Bloody Mess", level: 42, maxRank: 3, cost: [1, 2, 3], desc: ["LCKの値の25%分のダメージボーナス。出血中の敵を倒すと爆発する可能性がある。", "LCKの値の50%分のダメージボーナス。出血中の敵を倒すと爆発する可能性がある。", "LCKの値の75%分のダメージボーナス。出血中の敵を倒すと爆発する可能性がある。"] },
        ...
        { name: "Pharma Farma", level: 2, maxRank: 1, cost: [1], desc: ["LCKに応じて医療用コンテナから追加の薬品を発見する。"] },
        ...
        { name: "Scrounger", level: 3, maxRank: 1, cost: [1], desc: ["LCKに応じて弾薬コンテナから追加弾薬を発見する。"] },
...
const LEGENDARY_PERKS = [
    ...
    { name: "Legendary Strength", maxRank: 4, desc: ["STR+1、耐性+5。", "STR+2、耐性+10。", "STR+3、耐性+15。", "STR+5、耐性+25。"], special: "Strength" },
    { name: "Legendary Perception", maxRank: 4, desc: ["PER+1、耐性+5。", "PER+2、耐性+10。", "PER+3、耐性+15。", "PER+5、耐性+25。"], special: "Perception" },
    { name: "Legendary Endurance", maxRank: 4, desc: ["END+1、耐性+5。", "END+2、耐性+10。", "END+3、耐性+15。", "END+5、耐性+25。"], special: "Endurance" },
    { name: "Legendary Charisma", maxRank: 4, desc: ["CHR+1、耐性+5。", "CHR+2、耐性+10。", "CHR+3、耐性+15。", "CHR+5、耐性+25。"], special: "Charisma" },
    { name: "Legendary Intelligence", maxRank: 4, desc: ["INT+1、耐性+5。", "INT+2、耐性+10。", "INT+3、耐性+15。", "INT+5、耐性+25。"], special: "Intelligence" },
    { name: "Legendary Agility", maxRank: 4, desc: ["AGI+1、耐性+5。", "AGI+2、耐性+10。", "AGI+3、耐性+15。", "AGI+5、耐性+25。"], special: "Agility" },
    { name: "Legendary Luck", maxRank: 4, desc: ["LCK+1、耐性+5。", "LCK+2、耐性+10。", "LCK+3、耐性+15。", "LCK+5、耐性+25。"], special: "Luck" },
