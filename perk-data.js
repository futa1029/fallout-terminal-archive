...
const PERK_DATA = {
    "Strength": [
        ...
        { name: "Bear Arms", level: 35, maxRank: 3, cost: [1, 2, 3], desc: ["ヘビー武器の重量が30%軽くなる。", "ヘビー武器の重量が60%軽くなる。", "ヘビー武器の重量が90%軽くなる。"] },
        { name: "Blocker", level: 21, maxRank: 3, cost: [1, 2, 3], desc: ["近接攻撃からのダメージを15%軽減する。", "近接攻撃からのダメージを30%軽減する。", "近接攻撃からのダメージを45%軽減する。"] },
        { name: "Expert Gladiator", level: 15, maxRank: 3, cost: [1, 2, 3], desc: ["片手近接武器のダメージが+10%増加する。", "片手近接武器のダメージが+15%増加する。", "片手近接武器のダメージが+20%増加する。"] },
        { name: "Expert Heavy Gunner", level: 20, maxRank: 3, cost: [1, 2, 3], desc: ["非爆発系ヘビー武器のダメージが+10%増加する。", "非爆発系ヘビー武器のダメージが+15%増加する。", "非爆発系ヘビー武器のダメージが+20%増加する。"] },
        { name: "Expert Shotgunner", level: 20, maxRank: 3, cost: [1, 2, 3], desc: ["ショットガンのダメージが+10%増加する。", "ショットガンのダメージが+15%増加する。", "ショットガンのダメージが+20%増加する。"] },
        { name: "Expert Slugger", level: 20, maxRank: 3, cost: [1, 2, 3], desc: ["両手近接武器のダメージが+10%増加する。", "両手近接武器のダメージが+15%増加する。", "両手近接武器のダメージが+20%増加する。"] },
        { name: "Full Charge", level: 33, maxRank: 2, cost: [1, 2], desc: ["PA装着中のスプリントによるフュージョンコア消費が50%減少する。", "PA装着中のスプリントによるフュージョンコア消費がなくなる。"] },
        { name: "Gladiator", level: 2, maxRank: 3, cost: [1, 2, 3], desc: ["片手近接武器のダメージが+10%増加する。", "片手近接武器のダメージが+15%増加する。", "片手近接武器のダメージが+20%増加する。"] },
        { name: "Heavy Gunner", level: 10, maxRank: 3, cost: [1, 2, 3], desc: ["非爆発系ヘビー武器のダメージが+10%増加する。", "非爆発系ヘビー武器のダメージが+15%増加する。", "非爆発系ヘビー武器のダメージが+20%増加する。"] },
        ...
        { name: "Master Gladiator", level: 25, maxRank: 3, cost: [1, 2, 3], desc: ["片手近接武器のダメージが+10%増加する。", "片手近接武器のダメージが+15%増加する。", "片手近接武器のダメージが+20%増加する。"] },
        { name: "Master Heavy Gunner", level: 30, maxRank: 3, cost: [1, 2, 3], desc: ["非爆発系ヘビー武器のダメージが+10%増加する。", "非爆発系ヘビー武器のダメージが+15%増加する。", "非爆発系ヘビー武器のダメージが+20%増加する。"] },
        { name: "Master Shotgunner", level: 30, maxRank: 3, cost: [1, 2, 3], desc: ["ショットガンのダメージが+10%増加する。", "ショットガンのダメージが+15%増加する。", "ショットガンのダメージが+20%増加する。"] },
        { name: "Master Slugger", level: 30, maxRank: 3, cost: [1, 2, 3], desc: ["両手近接武器のダメージが+10%増加する。", "両手近接武器のダメージが+15%増加する。", "両手近接武器のダメージが+20%増加する。"] },
        { name: "Ordnance Express", level: 31, maxRank: 3, cost: [1, 2, 3], desc: ["爆発物の重量が30%軽くなる。", "爆発物の重量が60%軽くなる。", "爆発物の重量が90%軽くなる。"] },
        { name: "Pack Rat", level: 7, maxRank: 3, cost: [1, 2, 3], desc: ["全てのジャンクアイテムの重量が25%軽くなる。", "全てのジャンクアイテムの重量が50%軽くなる。", "全てのジャンクアイテムの重量が75%軽くなる。"] },
        ...
        { name: "Portable Power", level: 24, maxRank: 2, cost: [1, 2], desc: ["パワーアーマーのパーツの重量が25%軽くなる。", "パワーアーマーのパーツの重量が50%軽くなる。"] },
        { name: "Scattershot", level: 18, maxRank: 3, cost: [1, 2, 3], desc: ["ショットガンの重量が30%軽くなり、リロード速度が+10%速くなる。", "ショットガンの重量が60%軽くなり、リロード速度が+20%速くなる。", "ショットガンの重量が90%軽くなり、リロード速度が+30%速くなる。"] },
        { name: "Shotgunner", level: 10, maxRank: 3, cost: [1, 2, 3], desc: ["ショットガンのダメージが+10%増加する。", "ショットガンのダメージが+15%増加する。", "ショットガンのダメージが+20%増加する。"] },
        { name: "Slugger", level: 6, maxRank: 3, cost: [1, 2, 3], desc: ["両手近接武器のダメージが+10%増加する。", "両手近接武器のダメージが+15%増加する。", "両手近接武器のダメージが+20%増加する。"] },
        { name: "Strong Arm", level: 5, maxRank: 1, cost: [1], desc: ["投擲武器をより遠くに投げられる。"] },
        { name: "Strong Back", level: 26, maxRank: 4, cost: [1, 2, 3, 4], desc: ["所持重量+10。", "所持重量+20。", "所持重量+30。", "所持重量+40。"] },
    ...
    "Perception": [
        ...
        { name: "Commando", level: 2, maxRank: 3, cost: [1, 2, 3], desc: ["オートマチック武器のダメージが+10%増加する。", "オートマチック武器のダメージが+15%増加する。", "オートマチック武器のダメージが+20%増加する。"] },
        { name: "Concentrated Fire", level: 2, maxRank: 3, cost: [1, 2, 3], desc: ["V.A.T.S.で部位を狙える。命中率とダメージが各ショットごとに+1%。", "V.A.T.S.で部位を狙える。命中率とダメージが各ショットごとに+2%。", "V.A.T.S.で部位を狙える。命中率とダメージが各ショットごとに+3%。"] },
        { name: "Crack Shot", level: 7, maxRank: 3, cost: [1, 2, 3], desc: ["ピストルの射程と精度が+10%向上する。", "ピストルの射程と精度が+20%向上する。", "ピストルの射程と精度が+30%向上する。"] },
        { name: "Expert Commando", level: 15, maxRank: 3, cost: [1, 2, 3], desc: ["オートマチック武器のダメージが+10%増加する。", "オートマチック武器のダメージが+15%増加する。", "オートマチック武器のダメージが+20%増加する。"] },
        { name: "Expert Rifleman", level: 15, maxRank: 3, cost: [1, 2, 3], desc: ["ノンオートマチックライフルのダメージが+10%増加する。", "ノンオートマチックライフルのダメージが+15%増加する。", "ノンオートマチックライフルのダメージが+20%増加する。"] },
        ...
        { name: "Master Commando", level: 30, maxRank: 3, cost: [1, 2, 3], desc: ["オートマチック武器のダメージが+10%増加する。", "オートマチック武器のダメージが+15%増加する。", "オートマチック武器のダメージが+20%増加する。"] },
        { name: "Master Rifleman", level: 30, maxRank: 3, cost: [1, 2, 3], desc: ["ノンオートマチックライフルのダメージが+10%増加する。", "ノンオートマチックライフルのダメージが+15%増加する。", "ノンオートマチックライフルのダメージが+20%増加する。"] },
        ...
        { name: "Rifleman", level: 2, maxRank: 3, cost: [1, 2, 3], desc: ["ノンオートマチックライフルのダメージが+10%増加する。", "ノンオートマチックライフルのダメージが+15%増加する。", "ノンオートマチックライフルのダメージが+20%増加する。"] },
    ...
    "Charisma": [
        { name: "Animal Friend", level: 28, maxRank: 3, cost: [1, 2, 3], desc: ["照準時に動物が20%の確率で戦闘停止。", "照準時に動物が30%の確率で戦闘停止。", "照準時に動物が味方になる。"] },
        { name: "Bodyguards", level: 5, maxRank: 4, cost: [1, 2, 3, 4], desc: ["チームメイト1人ごとにDR+6、ER+6。", "チームメイト1人ごとにDR+8、ER+8。", "チームメイト1人ごとにDR+10、ER+10。", "チームメイト1人ごとにDR+12、ER+12。"] },
        { name: "EMT", level: 9, maxRank: 3, cost: [1, 2, 3], desc: ["蘇生速度が+30%速くなる。", "蘇生速度が+60%速くなる。", "蘇生速度が+100%速くなる。"] },
        ...
        { name: "Hard Bargain", level: 7, maxRank: 3, cost: [1, 2, 3], desc: ["ベンダーとの売買価格が改善。", "ベンダーとの売買価格がさらに改善。", "ベンダーとの売買価格が大幅に改善。"] },
        { name: "Inspirational", level: 2, maxRank: 3, cost: [1, 2, 3], desc: ["チーム全員のXP獲得量+5%。", "チーム全員のXP獲得量+10%。", "チーム全員のXP獲得量+15%。"] },
        { name: "Lone Wanderer", level: 4, maxRank: 4, cost: [1, 2, 3, 4], desc: ["ソロ時にダメージ+10%、AP回復+10%。", "ソロ時にダメージ+15%、AP回復+20%。", "ソロ時にダメージ+20%、AP回復+30%。", "ソロ時にダメージ+20%、AP回復+30%、DR+40。"] },
        ...
        { name: "Party Boy/Girl", level: 15, maxRank: 3, cost: [1, 2, 3], desc: ["アルコールの正の効果が2倍。", "アルコールの正の効果が3倍。", "アルコールの正の効果が低下しない。"] },
        ...
        { name: "Spiritual Healer", level: 10, maxRank: 3, cost: [1, 2, 3], desc: ["プレイヤーを蘇生するとHP回復が5%増加。", "プレイヤーを蘇生するとHP回復が10%増加。", "プレイヤーを蘇生するとHP回復が15%増加。"] },
        { name: "Squad Maneuvers", level: 33, maxRank: 2, cost: [1, 2], desc: ["チーム全員の移動速度+10%。", "チーム全員の移動速度+20%。"] },
        { name: "Strange in Numbers", level: 30, maxRank: 1, cost: [1], desc: ["チームメイトも変異持ちの場合、変異のプラス効果が+25%。"] },
        { name: "Suppressor", level: 20, maxRank: 3, cost: [1, 2, 3], desc: ["攻撃した標的のダメージ出力を10%減少させる。", "攻撃した標的のダメージ出力を20%減少させる。", "攻撃した標的のダメージ出力を30%減少させる。"] },
        { name: "Team Medic", level: 29, maxRank: 3, cost: [1, 2, 3], desc: ["スティムパック使用時にチーム全体も回復。", "スティムパック使用時にチーム全体もより多く回復。", "スティムパック使用時にチーム全体も大幅に回復。"] },
        { name: "Tenderizer", level: 22, maxRank: 3, cost: [1, 2, 3], desc: ["攻撃した標的が受けるダメージが5%増加する。", "攻撃した標的が受けるダメージが7%増加する。", "攻撃した標的が受けるダメージが10%増加する。"] },
        { name: "Travel Agent", level: 8, maxRank: 1, cost: [1], desc: ["ファストトラベルのキャップコストが30%減少。"] },
        { name: "Wasteland Whisperer", level: 34, maxRank: 3, cost: [1, 2, 3], desc: ["照準時にクリーチャーが20%の確率で戦闘停止。", "照準時にクリーチャーが30%の確率で戦闘停止。", "照準時にクリーチャーが味方になる。"] }
    ],
    "Intelligence": [
        { name: "Batteries Included", level: 22, maxRank: 3, cost: [1, 2, 3], desc: ["エネルギー弾の重量が30%軽くなる。", "エネルギー弾の重量が60%軽くなる。", "エネルギー弾の重量が90%軽くなる。"] },
    ...
    "Agility": [
        ...
        { name: "Expert Guerrilla", level: 15, maxRank: 3, cost: [1, 2, 3], desc: ["オートマチックピストルのダメージが+10%。", "オートマチックピストルのダメージが+15%。", "オートマチックピストルのダメージが+20%。"] },
        { name: "Expert Gunslinger", level: 20, maxRank: 3, cost: [1, 2, 3], desc: ["ノンオートマチックピストルのダメージが+10%。", "ノンオートマチックピストルのダメージが+15%。", "ノンオートマチックピストルのダメージが+20%。"] },
        { name: "Guerrilla", level: 2, maxRank: 3, cost: [1, 2, 3], desc: ["オートマチックピストルのダメージが+10%。", "オートマチックピストルのダメージが+15%。", "オートマチックピストルのダメージが+20%。"] },
        { name: "Gun Runner", level: 8, maxRank: 1, cost: [2], desc: ["武器装備中の移動速度が+10%速くなる。"] },
        { name: "Gunslinger", level: 6, maxRank: 3, cost: [1, 2, 3], desc: ["ノンオートマチックピストルのダメージが+10%。", "ノンオートマチックピストルのダメージが+15%。", "ノンオートマチックピストルのダメージが+20%。"] },
        ...
        { name: "Master Guerrilla", level: 30, maxRank: 3, cost: [1, 2, 3], desc: ["オートマチックピストルのダメージが+10%。", "オートマチックピストルのダメージが+15%。", "オートマチックピストルのダメージが+20%。"] },
        { name: "Master Gunslinger", level: 30, maxRank: 3, cost: [1, 2, 3], desc: ["ノンオートマチックピストルのダメージが+10%。", "ノンオートマチックピストルのダメージが+15%。", "ノンオートマチックピストルのダメージが+20%。"] },
        ...
        { name: "Thru-Hiker", level: 3, maxRank: 3, cost: [1, 2, 3], desc: ["食料と飲料の重量が30%軽くなる。", "食料と飲料の重量が60%軽くなる。", "食料と飲料の重量が90%軽くなる。"] },
